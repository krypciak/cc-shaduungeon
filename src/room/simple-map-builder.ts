...
import {
    SimpleDoubleTunnelRoom,
    SimpleMultipleExitTunnelRoom,
    SimpleOpenTunnelRoom,
    SimpleRoom,
    SimpleTunnelEndRoom,
    SimpleTunnelRoom,
} from '@root/room/simple-room'
...
export class SimpleRoomMapBuilder extends MapBuilder {
    ...
    constructor(
        ...
        this.simpleRoom = this.entarenceRoom = new SimpleRoom(new MapPoint(0, 0), new MapPoint(16, 16), entDir, exitDir)
    ...
    static addRandom(
        ...
        areaInfo: AreaInfo,
        num: number,
        creators: (new (areaInfo: AreaInfo, ent: Dir, exit: Dir) => MapBuilder)[] = [SimpleRoomMapBuilder]
    ) {
        for (let i = 0; i < num; i++) {
...
export class SimpleSingleTunnelMapBuilder extends MapBuilder {
    ...
    constructor(
        ...
        super(3, areaInfo, RoomTheme.default)
        this.simpleRoom = this.entarenceRoom = new SimpleTunnelRoom(
            new MapPoint(0, 0),
            new MapPoint(16, 16),
            entDir,
            exitDir
...
export class SimpleDoubleTunnelMapBuilder extends MapBuilder {
    ...
    constructor(
        ...
        super(3, areaInfo, RoomTheme.default)
        this.simpleRoom = this.entarenceRoom = new SimpleDoubleTunnelRoom(
            new MapPoint(0, 0),
            new MapPoint(16, 16),
            entDir,
            exitDir
...
export class SimpleDoubleRoomMapBuilder extends MapBuilder {
    ...
    constructor(
        ...
        const pos: MapPoint =
            this.simpleRoom.primaryEntarence.tunnel.getRoomPosThatConnectsToTheMiddle(entarenceRoomSize)
        this.entarenceRoom = new Room(
            'simple',
            MapRect.fromTwoPoints(pos, entarenceRoomSize),
            [true, true, true, true],
            true
        )
        this.simpleRoom.pushAllRooms(this.rooms)
    ...
    prepareToArrange(dir: Dir): boolean {
        ...
        this.entarenceRoom.primaryEntarence = new RoomIOTunnelClosed(
            this.entarenceRoom,
            DirUtil.flip(dir),
            entTunnelSize,
            this.entarenceRoom.middlePoint(MapPoint).to(EntityPoint),
            true
        )
...
export class SimpleMultipleExitMapBuilder extends MapBuilder {
    ...
    constructor(
        ...
        this.entarenceRoom = this.simpleRoom = new SimpleMultipleExitTunnelRoom(
            new MapPoint(0, 0),
            new MapPoint(24, 24),
            entDir,
            ...exits
...
export class SimpleSingleTunnelEndMapBuilder extends MapBuilder {
    ...
    constructor(
        ...
        super(3, areaInfo, RoomTheme.default)
        this.simpleRoom = this.entarenceRoom = new SimpleTunnelEndRoom(
            new MapPoint(0, 0),
            new MapPoint(16, 16),
            entDir,
            exitDir
